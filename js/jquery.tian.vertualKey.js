...
(function( $, undefined ) {
    ...
    $.extend($.ui, { virtualKeybord: { version: "1.10.4" } });

    var PROP_NAME = "virtualKeybord",
        instActive;
    ...
    $.extend(VirtualKeybord.prototype, {
...
//                inst.currentDay, inst.currentMonth, inst.currentYear));
        ...
        _generateHTML: function(inst) {
            ...
            for (row = 0; row < numMonths[0]; row++) {
                ...
                for (col = 0; col < numMonths[1]; col++) {
                    ...
                    for (dRow = 0; dRow < 2; dRow++) { // create date picker rows
                        calender += "<tr>";
                        tbody = "";
    ...
    $.datepicker = new VirtualKeybord(); // singleton instance
